# The following code includes all scripts executed in the analysis and visualization of Slumber in a cell.
...
# Contents:
# Perform basic summary statistics on event separations, both less than and greater than 10s.
# Test for differences between behavior counts in a census.
# Test if behavior counts differ between day and night.
# Figure 5: Make a stacked boxplot showing the proportions of behaviors at any given time.
# Figure 6: Make a plot of all bee gaster ventilation event times in seconds.
# Figure 7a: Make histograms of event separations.
# Figure 7b (bottom): Make boxplots of the separations between gaster pumps, sorted by behavior.
# Figure 7b (top): Make boxplots of the separations between gaster pumps, sorted by behavior.
# Figure 8: Make a plot showing the difference between thorax and surrounding temperature.
...
# Test for temperature differences between behaviors, and for effect of duration in cell on temperature.
